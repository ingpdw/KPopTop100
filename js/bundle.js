 ...
 * project: kpop
 * author: pdw
 * update: Thu May 04 2017 16:17:44 GMT+0900 (KST)
 * version: 1.0.0
 */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _YoutubeFrame = __webpack_require__(222);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_YoutubeFrame2.default, { query: this.state.query, target: this.state.target })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SongList = function (_React$Component) {
	  ...
	  _createClass(SongList, [{
	    ...
	    value: function componentDidMount() {
	      var planetKey = '97ab7564-88ff-3038-8c7f-ad6257ec2684';
	      var planetApi = 'http://apis.skplanetx.com/melon/charts/todaytopsongs';
	      PlanetX.init({
	        appkey: planetKey,
	        savingToken: true
	      });
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onSearch: function onSearch(sname) {
	      return dispatch((0, _actions.searching)(sname));
	    }
	  };
	};

	SongList = (0, _reactRedux.connect)(undefined, mapDispatchToProps)(SongList);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Rank = __webpack_require__(162);

	var _Rank2 = _interopRequireDefault(_Rank);

	var _SongName = __webpack_require__(163);

	var _SongName2 = _interopRequireDefault(_SongName);

	var _Artist = __webpack_require__(220);
	...
	var Song = function (_React$Component) {
	  ...
	  _createClass(Song, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'li',
	        { style: songStyle, key: this.props.key },
	        _react2.default.createElement(_Rank2.default, { rank: this.props.rank }),
	        _react2.default.createElement(_SongName2.default, { name: this.props.songName }),
	        _react2.default.createElement(_Artist2.default, { name: this.props.artistName })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SongName = function (_React$Component) {
	  _inherits(SongName, _React$Component);

	  function SongName() {
	    _classCallCheck(this, SongName);

	    return _possibleConstructorReturn(this, (SongName.__proto__ || Object.getPrototypeOf(SongName)).apply(this, arguments));
	  }

	  _createClass(SongName, [{
	    key: 'showYoutube',
	    value: function showYoutube(evt) {
	      evt.preventDefault();
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onSearch: function onSearch(sname, target) {
	      return dispatch((0, _actions.searching)(sname, target));
	    }
	  };
	};

	SongName = (0, _reactRedux.connect)(undefined, mapDispatchToProps)(SongName);
...
/***/ (function(module, exports) {
	...
	function searching(name, target) {
	  return {
	    type: SEARCHING,
	    name: name,
	    target: target
	  ...
	  _createClass(Search, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { style: searchStyle },
	        _react2.default.createElement('input', { style: searchInputStyle,
	          type: 'text',
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onSearch: function onSearch(value) {
	      return dispatch((0, _actions.searching)(value));
	    }
	  };
	};

	Search = (0, _reactRedux.connect)(undefined, mapDispatchToProps)(Search);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var YoutubeFrame = function (_React$Component) {
	  _inherits(YoutubeFrame, _React$Component);
	  ...
	  _createClass(YoutubeFrame, [{
	    ...
	    value: function componentDidUpdate(prevProps, prevState) {
	      var currentNode = _reactDom2.default.findDOMNode(this);
	    ...
	    value: function render() {
	      ...
	      var youtubeParam = '?listType=search&autoplay=0&rel=0&hd=1&showinfo=0';
	      var frameStyle = {
	      ...
	      return _react2.default.createElement('iframe', { style: frameStyle,
	        frameBorder: '0',
	        scrolling: 'no',
	...
	YoutubeFrame = (0, _reactRedux.connect)(mapStateToProps)(YoutubeFrame);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var searching = function searching() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : searchInitialState;
	  var action = arguments[1];

	  switch (action.type) {
	    case _actions.SEARCHING:
	...
	var searchReducer = (0, _redux.combineReducers)({ searching: searching });
